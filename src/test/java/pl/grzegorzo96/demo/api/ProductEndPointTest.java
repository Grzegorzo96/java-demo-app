...
public class ProductEndPointTest extends DemoApplicationTests {
    ...
    public void shouldGetExistingProducts(){
        ...
        final String url = "http://localhost:" + port + "/products/" + "product-id-" +existingProduct.getId();
        //when
        ResponseEntity<ProductResponseDto> result = httpClient.getForEntity(url, ProductResponseDto.class);
        //ten
    ...
    public void shouldUpdateProduct(){
        ...
        ProductRequestDto updatedProduct = new ProductRequestDto("Product is updated", priceDto);
    ...
    String mapToJson(ProductRequestDto productRequestDto){
        try {
           ...
           // e.printStackTrace(); //najgorsze rozwiazanie - usuniecie tego i dacie pustego resulta (string)
        }
    }
